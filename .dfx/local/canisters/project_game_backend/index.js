...
import { idlFactory } from './project_game_backend.did.js';
export { idlFactory } from './project_game_backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.PROJECT_GAME_BACKEND_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./project_game_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the project_game_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./project_game_backend.did.js")._SERVICE>}
 */
export const project_game_backend = createActor(canisterId);
